...
PATCHES=(
	...
	#Rpi stuff
	"${FILESSDIR}"/0050-bcm43xx-Add-bcm43xx-3wire-variant.patch
	#"${FILESSDIR}"/0051-bcm43xx-The-UART-speed-must-be-reset-after-the-firmw.patch
	"${FILESSDIR}"/0052-Increase-firmware-load-timeout-to-30s.patch
	"${FILESSDIR}"/0053-Move-43xx-firmware-to-lib-firmware.patch
